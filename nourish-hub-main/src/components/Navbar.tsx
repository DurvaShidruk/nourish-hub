        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="hidden md:flex items-center gap-1 px-3 py-2 rounded-xl text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted transition"
            >
        ...
        {mobileOpen && (
          ...
          >
            <div className="px-4 py-3 flex flex-col gap-1">
              ...
              <button
                onClick={handleLogout}
                className="mt-2 px-4 py-2.5 rounded-xl text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted transition text-left"
              >
                Logout
              </button>
